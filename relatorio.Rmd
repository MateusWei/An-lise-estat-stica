---
title: "Relatório"
author: "Mateus Anderson da Silva Wei"
date: "2023-01-30"
output:
  html_document:
    toc: true
...
# Contextualização
Relatório feito em R Markdown apresentando as estatísticas e os gráficos obtidos apartir das informações fornecidas. Tais informações envolvem a observação de vários dias da quantidade de enterococcus presentes nas águas das praias de Mongaguá em São Paulo.
...
```{r, echo=FALSE}
kable(head(df, 10), col.names = c("City","Beach","Date","Enterococcus")) %>% 
  kable_styling(full_width = FALSE, bootstrap_options =c ("striped","hover","condensed","responsive"))
```

<br> A tabela possui `r nrow(df)` linhas.
...
```{r, echo=FALSE}
kable(head(newDf, 10), col.names = c("Beach","media","desvio","mediana","q1","q3","min","max")) %>% 
  kable_styling(full_width = FALSE, bootstrap_options =c ("striped","hover","condensed","responsive"))
```
